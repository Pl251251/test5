...
pts1 = np.float32([[491, 703], [651, 245], [1985, 634], [2024, 122]])
...
try:
    circles = cv2.HoughCircles(gray,cv2.HOUGH_GRADIENT,1,20,param1=50,param2=30,minRadius=90,maxRadius=120)
...
result2 = cv2.warpPerspective(result, matrix2, (2000, 1000))
# Wrap the transformed image
